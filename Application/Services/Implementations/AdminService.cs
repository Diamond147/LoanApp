...
namespace Application.Services.Implementations
{
    public class AdminService : IAdminService
    {
        ...
        //// User Management
        //public async Task<ContinuationResponse<AdminUserDto>> GetAllUsersAsync(int pageSize, string? continuationToken, string? userId)
        //{
        //    try
        //    {
        //        if (pageSize < 1 || pageSize > 100)
        ...
        //        }
        //        var (users, newContinuationToken) = await _adminRepository.GetAllUsersAsync(pageSize, continuationToken, userId);
        ...
        //            throw new ValidationException("PageSize must be between 1 and 100");
        //        }
        //        var (loans, newContinuationToken) = await _adminRepository.GetAllLoansAsync(pageSize, continuationToken, status, loanId);
